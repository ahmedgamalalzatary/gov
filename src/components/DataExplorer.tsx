...
export default function DataExplorer() {
  ...
  function sortProps(key: SortKey) {
    ...
    return {
      ...
      "aria-sort": (active ? (sortDir === "asc" ? "ascending" : "descending") : "none") as "ascending" | "descending" | "none",
      className: active ? "sortbtn sortbtn--active" : "sortbtn",
    };
  }

  return (
    <div className="wrap" style={{ paddingBlock: "2rem 4rem" }}>
      <section>
        <div className="filters">
          <div className="filter-row">
            <input
              type="search"
              placeholder="ابحث: مدرسة، نقل، كوبري..."
              value={q}
        ...
        <div className="tabs">
          <button
            type="button"
            className={tab === "table" ? "tab tab--active" : "tab"}
          ...
          <button
            type="button"
            className={tab === "charts" ? "tab tab--active" : "tab"}
            ...
            <div className="table-frame">
              <table className="data-table">
                <thead>
                  <tr>
                    <th scope="col">
                      <button type="button" {...sortProps("gov")}>
                        المحافظة{" "}
                        <i aria-hidden="true" className="sort-icon">
                          ▾
                        </i>
                      </button>
                    </th>
                    <th scope="col">
                      <button type="button" {...sortProps("sector")}>
                        القطاع{" "}
                        <i aria-hidden="true" className="sort-icon">
                          ▾
                        </i>
                    ...
                    <th scope="col">
                      <button type="button" {...sortProps("indicator")}>
                        البيان{" "}
                        <i aria-hidden="true" className="sort-icon">
                          ▾
                        </i>
                    ...
                    <th scope="col">
                      <button type="button" {...sortProps("value")}>
                        القيمة{" "}
                        <i aria-hidden="true" className="sort-icon">
                          ▾
                        </i>
